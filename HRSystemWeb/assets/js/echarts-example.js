...
var echartsBarTimelineChartInitSale = function echartsBarTimelineChartInitSale(data) {
    ...
    if ($barTimelineChartEl) {
        ...
        var dataFormatter = function(data) {
            ...
            data.forEach(function(item) {
                ...
                formattedData[year][monthIndex] += item.Amount;
            });
            return formattedData;
        };

        var formattedData = dataFormatter(data);
        dataMap.dataTI = dataFormatter(data.filter(item => item.StockCategoryCode === 'VEGETABLE OIL'));
        dataMap.dataSI = dataFormatter(data.filter(item => item.StockCategoryCode === 'RICE'));
        dataMap.dataPI = dataFormatter(data.filter(item => item.StockCategoryCode === 'FERTILIZER'));
            ...
            return {
                baseOption: {
                    timeline: {
                        ...
                        autoPlay: false,
                        playInterval: 1000,
                        data: Object.keys(formattedData).map(year => `${year}-01-01`),
                        label: {
                    ...
                    legend: {
                        left: 'right',
                        data: ['VEGETABLE OIL', 'RICE', 'FERTILIZER'],
                        textStyle: {
                            color: utils.getGrays()['700']
                        }
                    },
                ...
                options: Object.keys(formattedData).map(year => ({
                    title: {
                        text: year
                    },
                    series: [{
...
//var echartsPieChartInit = function echartsPieChartInit(data) {
function echartsPieChartInit(data) {
    ...
    if ($pieChartEl) {
            ...
            return {
                ...
                series: [{
                    ...
                    data: data.map(item => ({
                        ...
                        name: item.Name,
                        itemStyle: {
                            color: utils.getColor(item.Color)
                        },
                    })),
        ...
        // Call echartSetOption if it's defined
        if (typeof echartSetOption === 'function') {
            echartSetOption(chart, userOptions, getDefaultOptions);
        }
...
function echartsPieChartInits(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Fertilizer');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitAll(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-All');
    //var $legendContainerEl = document.querySelector('#legend-container');
        ...
        var getDefaultOptions = function () {
            return {
                legend: {
                    ...
                    orient: 'horizontal', // Vertical orientation for better scrolling
                    left: 'left',
                    textStyle: {
                        color: '#333', // Customize the color as needed
                        fontSize: 12 // Set the font size for the legend here
                    },
                    // Position the legend inside the container
...
function echartsPieChartInitsRice(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Rice');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsFuel(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Fuel');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsOil(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Oil');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsFaq(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Faq');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsCrudeOil(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-CrudeOil');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsShells(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Shells');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
function echartsPieChartInitsCake(data) {
    var $pieChartEl = document.querySelector('.echart-pie-chart-Cake');
    if ($pieChartEl) {
        // Get options from data attribute
        var userOptions = utils.getData($pieChartEl, 'options');
        var chart = window.echarts.init($pieChartEl);
...
docReady(echartsPieChartInitAll);
docReady(echartsPieChartInits);
docReady(echartsPieChartInitsRice);
docReady(echartsPieChartInitsFuel);
docReady(echartsPieChartInitsFaq);
docReady(echartsPieChartInitsOil);
docReady(echartsPieChartInitsShells);
docReady(echartsPieChartInitsCake);
docReady(echartsPieChartInitsCrudeOil);
...
docReady(echartsBarTimelineChartInitSale);
