<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="VisitorsList.aspx.cs" Inherits="HRSystemWeb.VisitorsList"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <UC1:BreadCrumb ID="BreadCrumb1" Level="4" runat="server" TailName="Visitors List " />
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <asp:Label ID="lblPageName" runat="server" Text="Visitors List" CssClass="mb-0 h5" SkinID="LabelPageTitle"></asp:Label>
                            ...
                            <ContentTemplate>
                                <div class="table-responsive scrollbar">
                                    ...
                                    <asp:GridView ID="grdRequest" runat="server" PageSize="20" AllowPaging="True" CssClass="table table-hover table-bordered table-striped overflow-hidden"
                                        AutoGenerateColumns="false" Width="100%" DataKeyNames="Visitor"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnView" runat="server" Text="View" CommandName="View" CommandArgument='<%# Eval("Visitor") %>' CssClass="btn btn-primary btn-sm" />
                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CommandName="SelectItem" CommandArgument='<%# Eval("Visitor") %>' CssClass="btn btn-primary btn-sm" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:HyperLinkField DataNavigateUrlFields="JumpParam" Visible="false" Text="View" DataNavigateUrlFormatString="Visitors.aspx?{0}"
                                                HeaderText="Visitor " DataTextField="Visitor">
