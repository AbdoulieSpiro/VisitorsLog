<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DepartmentList.aspx.cs" Inherits="HRSystemWeb.DepartmentList"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <UC1:BreadCrumb ID="BreadCrumb1" Level="4" runat="server" TailName="Department List " />
                            ...
                            <ContentTemplate>
                                <div class="table-responsive scrollbar">
                                    ...
                                    <asp:GridView ID="grdRequest" runat="server" PageSize="20" AllowPaging="True" CssClass="table table-hover table-bordered table-striped overflow-hidden"
                                        AutoGenerateColumns="false" Width="100%" DataKeyNames="Department"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnView" runat="server" Text="View" CommandName="View" CommandArgument='<%# Eval("Department") %>' CssClass="btn btn-primary btn-sm" />
                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CommandName="SelectItem" CommandArgument='<%# Eval("Department") %>' CssClass="btn btn-primary btn-sm" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:HyperLinkField DataNavigateUrlFields="JumpParam" Visible="false" Text="View" DataNavigateUrlFormatString="Department.aspx?{0}"
                                                HeaderText="Department " DataTextField="Department">
                                                <HeaderStyle Width="15%" HorizontalAlign="Left" />
                                            </asp:HyperLinkField>
                                            <asp:BoundField DataField="DepartmentX" HeaderText="Code" />
                                            <asp:BoundField DataField="DepartmentXX" HeaderText="Name" />
                                        </Columns>
