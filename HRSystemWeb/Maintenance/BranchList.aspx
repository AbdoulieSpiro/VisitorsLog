<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BranchList.aspx.cs" Inherits="HRSystemWeb.BranchList"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <UC1:BreadCrumb ID="BreadCrumb1" Level="4" runat="server" TailName="Branch List " />
                            ...
                            <ContentTemplate>
                                <div class="table-responsive scrollbar">
                                    ...
                                    <asp:GridView ID="grdRequest" runat="server" PageSize="20" AllowPaging="True" CssClass="table table-hover table-bordered table-striped overflow-hidden"
                                        AutoGenerateColumns="false" Width="100%" DataKeyNames="Branch"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnView" runat="server" Text="View" CommandName="View" CommandArgument='<%# Eval("Branch") %>' CssClass="btn btn-primary btn-sm" />
                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CommandName="SelectItem" CommandArgument='<%# Eval("Branch") %>' CssClass="btn btn-primary btn-sm" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:HyperLinkField DataNavigateUrlFields="JumpParam" Visible="false" Text="View" DataNavigateUrlFormatString="Branch.aspx?{0}"
                                                HeaderText="Branch " DataTextField="Branch">
                                                <HeaderStyle Width="15%" HorizontalAlign="Left" />
                                            </asp:HyperLinkField>
                                            <asp:BoundField DataField="BranchX" HeaderText="Code" />
                                            <asp:BoundField DataField="BranchXX" HeaderText="Name" />
                                        </Columns>
