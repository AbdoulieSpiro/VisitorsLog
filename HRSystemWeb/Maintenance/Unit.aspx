<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Unit.aspx.cs" Inherits="HRSystemWeb.Unit"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <UC1:BreadCrumb ID="BreadCrumb1" class="form-label" Level="4" runat="server" TailName="Unit " />
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="Panel1" runat="server">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <asp:Label ID="Label6" CssClass="form-label" runat="server" Text="Unit Code:"> </asp:Label>
                                <asp:TextBox ID="txtUnitCode" runat="server" MaxLength="50" CssClass="form-control"
                                    Columns="35" Width="312px">
                                </asp:TextBox>
                            </div>

                            <div class="col-md-6">
                                <asp:Label ID="Label7" CssClass="form-label" runat="server" Text="Unit Name:"> </asp:Label>
                                <asp:TextBox ID="txtUnitName" runat="server" MaxLength="50" CssClass="form-control"
                                    Columns="35" Width="312px">
                                </asp:TextBox>
                            </div>
                        </div>
